...
def build(args):
    ...
    state_dict = torch.load(
        "./Trained models/FCBFormer_2ca{}.pt".format(args.train_dataset)
    )
...
def get_args():
    ...
    parser.add_argument(
        "--train-dataset", type=str,default='Kvasir', choices=["Kvasir", "CVC","isic"]
    )
    parser.add_argument(
        "--test-dataset", type=str, default='Kvasir', choices=["Kvasir", "CVC","isic"]
    )
    parser.add_argument("--data-root", type=str, default='C:/Users/78696/Desktop/息肉分割/FCBFormer-main/datasets/kvasir-seg/Kvasir-SEG/', dest="root")
